...
public class KYCCamera {
    ...
    public final static int    TYPE_CAPTURE_FACE_FRONT     = 4;//Front of user face

    /**
     * CAPTURE WITHOUR CROP
     */
    public final static int TYPE_CAPTURE_ID_WO_CROP = 5;
    public final static int TYPE_CAPTURE_FACE_WO_CROP = 6;
