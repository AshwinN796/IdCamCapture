...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mContext = context;
        TypedArray typedArray = mContext.obtainStyledAttributes(attributeSet, R.styleable.CameraPreview);
        isUsingFrontFacing = typedArray.getBoolean(R.styleable.CameraPreview_is_front_camera,false);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        if (isUsingFrontFacing) {
            camera = CameraUtils.openCamera(1);
        }else  {
